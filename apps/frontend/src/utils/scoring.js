export function calculateScore(answers) {
    ...
    if (answers.backupSolution?.toLowerCase() === "no" &&
    ...
    if (answers.accessControl?.toLowerCase() === "no formal system" &&
...
export function calculateConfidence(answers) {
    ...
    const notSureCount = notSureFields.filter((a) => a?.toLowerCase().includes("not sure")).length;
